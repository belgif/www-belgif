		...
		<section class="card be-eif">
			<div class="card-body">
				<h1 class="card-title"><i class="fas fa-cubes"></i>
					<a href="/eif3/about.${lang}.html" class="stretched-link text-decoration-none text-white">
					${eif.getTitle(lang)}</a>
				</h1>
		...
		<section class="card be-specs h-100">
			<div class="card-body">
				<h1 class="card-title"><i class="far fa-file-code"></i>
					<a href="/page/specifications.${lang}.html" class="stretched-link text-decoration-none text-white">
		...
		<section class="card be-activities h-100">
			<div class="card-body">
				<h1 class="card-title"><i class="fas fa-users"></i>
					<a href="/page/activities.${lang}.html" class="stretched-link text-decoration-none text-white">
		...
		<section class="card be-legal h-100">
			<div class="card-body">
				<h1 class="card-title"><i class="fas fa-balance-scale"></i> 
					<a href="/page/legislations.${lang}.html" class="stretched-link text-decoration-none text-white">
